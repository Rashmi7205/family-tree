        ...
        <section className="relative max-w-full mx-auto z-1">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8">
            <div className="space-y-5 max-w-4xl mx-auto text-center">
              <h1 className="text-sm font-medium text-primary bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 w-fit mx-auto">
                {title}
            ...
            {bottomImage && (
              <div className="mt-32 mx-10 relative z-10">
                <img
                  ...
                  className="w-full shadow-lg rounded-lg border border-gray-200 block dark:hidden"
